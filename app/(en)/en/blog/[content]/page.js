...
import blogContents from "@/locales/en/blogContent.json";
...
export function generateMetadata({ params: { content } }) {
  ...
  const keywords = "bolt, nut, washer, screw, pin, rivet, stud, stainless steel bolt, stainless steel nut, inox bolt, Allen bolt, smart screw, stainless steel washer, fasteners, bolt types, screw types";
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.inoksist.com.tr/en/blog/${content}`,
    },
  };
}
  ...
  const jsonLd = [
    {
      ...
      url: `https://www.inoksist.com.tr/en/blog/${content}`,
      mainEntityOfPage: {
        "@type": "WebPage",
