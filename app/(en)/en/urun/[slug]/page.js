...
import products from "@/locales/en/allData.json";
...
export function generateMetadata({ params: { slug } }) {
  ...
  const defaultKeywords = "inoksist, fasteners, hardware, maintenance chemicals, modular water tank, inoksist, inoks bolts, inox bolts, stainless steel bolts, stainless steel nuts, stainless steel washers";
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.inoksist.com.tr/en/urun/${slug}`,
    },
  };
}
  ...
  const jsonLd = [
    {
      ...
      url: `https://www.inoksist.com.tr/en/urun/${slug}`,
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": "https://www.inoksist.com.tr/en", // Ana sayfa URL'si
      },
    },

    {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      name: `${singleProductItem.name} - Inoksist Industry Stainless Steel Bolt Stainless Steel Nut`,
      ...
      description: `${singleProductItem.name} - For a price quote on our product, please contact us. ${singleProductItem.description}`,
    },
  ];
      ...
      <section>
        <Container>
          <Row>
            ...
            <Col lg="6">
              {/* Ürün Bilgileri */}
              <ProductInfo singleProductItem={singleProductItem} language="en" />
            </Col>
          </Row>
